...
export class WorkflowParser {
   ...
   */
  static parse(json: string, awareConfig: AwareConfig): Workflow {
    let parsed: any;
    ...
    return this.toRuntime(parsed, awareConfig);
  }
  ...
  private static toRuntime(json: any, awareConfig: AwareConfig): Workflow {
